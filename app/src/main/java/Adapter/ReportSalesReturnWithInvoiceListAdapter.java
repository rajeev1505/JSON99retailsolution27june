...
import com.mycompany.apps.ShowSalesReturnWithInvoiceListActivity;
...
public class ReportSalesReturnWithInvoiceListAdapter extends BaseAdapter
{
    ShowSalesReturnWithInvoiceListActivity activity;
    ...
    public ReportSalesReturnWithInvoiceListAdapter(ShowSalesReturnWithInvoiceListActivity activity, ArrayList<SalesReturnReportModel> list, int layoutResourceId, SalesReturnReportModel purchaseProductModel) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView=layoutInflater.inflate(R.layout.display_full_sale_withinvoice_list_row,parent,false);
