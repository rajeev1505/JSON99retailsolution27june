...
public class TransactionIdWithInvoiceSearchAdapter extends ArrayAdapter<String> {
    ...
    public TransactionIdWithInvoiceSearchAdapter(ReportSalesReturnWithInvoiceActivity activity, int textViewResourceId, ArrayList<String> objects) {
