...
public class FragmentDirectCashListAdapter extends BaseAdapter{

    LayoutInflater layoutInflater;
    ArrayList<DirectVendorPaymentModel> list = new ArrayList<DirectVendorPaymentModel>();
    private  Context context;

    public FragmentDirectCashListAdapter(ArrayList<DirectVendorPaymentModel> list, Context context) {
        super();
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView =layoutInflater.inflate(R.layout.display_report_direct_pay_by_cash,null);
