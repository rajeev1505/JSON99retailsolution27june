 ...
 */
public class FragmentSearchInventoryAdapter extends ArrayAdapter<InventoryReportModel> {
    ...
    public FragmentSearchInventoryAdapter(Context context, int resource, ArrayList<InventoryReportModel> objects)
    {
