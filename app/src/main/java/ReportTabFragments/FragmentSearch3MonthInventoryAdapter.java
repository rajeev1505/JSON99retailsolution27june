 ...
 */
public class FragmentSearch3MonthInventoryAdapter extends ArrayAdapter<InventoryReportModel> {
    ...
    public FragmentSearch3MonthInventoryAdapter(Context context, int resource, ArrayList<InventoryReportModel> objects)
    {
