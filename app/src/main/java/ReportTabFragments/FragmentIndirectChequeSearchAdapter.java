...
public class FragmentIndirectChequeSearchAdapter extends ArrayAdapter<IndirectVendorPaymentModel>{
    ...
    public FragmentIndirectChequeSearchAdapter(Context context, int resource, ArrayList<IndirectVendorPaymentModel> objects) {
