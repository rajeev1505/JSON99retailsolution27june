...
public class FragmentIndirectChequeListAdapter extends BaseAdapter{

    LayoutInflater layoutInflater;
    ArrayList<IndirectVendorPaymentModel> list = new ArrayList<IndirectVendorPaymentModel>();
    private  Context context;

    public FragmentIndirectChequeListAdapter(ArrayList<IndirectVendorPaymentModel> list, Context context) {
        super();
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView =layoutInflater.inflate(R.layout.display_report_indirect_pay_by_cheque,null);
