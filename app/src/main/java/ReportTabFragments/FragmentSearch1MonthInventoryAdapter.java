...
public class FragmentSearch1MonthInventoryAdapter extends ArrayAdapter<InventoryReportModel> {
    ...
    public FragmentSearch1MonthInventoryAdapter(Context context, int resource, ArrayList<InventoryReportModel> objects)
    {
