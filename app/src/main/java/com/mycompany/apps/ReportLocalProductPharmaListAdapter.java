...
public class ReportLocalProductPharmaListAdapter extends BaseAdapter {
    ...
    public ReportLocalProductPharmaListAdapter(ArrayList<ReportLocalProductPharmaModel> list, LocalProductPharmaReportActivity activity) {
        this.list = list;
