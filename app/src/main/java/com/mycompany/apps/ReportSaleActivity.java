...
import Adapter.GrandTotalListAdapter;
import Adapter.TransactionIdSearchAdapter;
...
public class ReportSaleActivity extends Activity {
    ...
    GrandTotalListAdapter totalListAdapter;
    ...
    TransactionIdSearchAdapter searchIdAdapter;
    ActionBar actionBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        monthList = (ListView) findViewById(R.id.lv_SaleReport);
      ...
      Submit.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              Log.e("Button",Submit.toString());

              arrayTotalList = helper.SaleData(fromString, toString);

              totalListAdapter = new GrandTotalListAdapter(arrayTotalList, ReportSaleActivity.this);
                    ...
                    public void afterTextChanged(Editable s) {
                        ...
                        if (searchIdList != null) {
                            if (searchIdAdapter == null) {
                                searchIdAdapter = new TransactionIdSearchAdapter(ReportSaleActivity.this, android.R.layout.simple_dropdown_item_1line, searchIdList);
...

        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (totalListAdapter == null) {
                    ...
                    totalListAdapter = new GrandTotalListAdapter(new ArrayList<SaleReportModel>(), ReportSaleActivity.this);
...
//                    idTextView.setText("");
...

        {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                String ty =null;
                for (SaleReportModel prod:arrayTotalList)
                {
                ...
                Intent intent = new Intent(getApplicationContext(), ShowSaleListActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i=new Intent(ReportSaleActivity.this,SaleReportActivity.class);
            startActivity(i);
            return true;
        }
