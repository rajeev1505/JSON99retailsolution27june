...
public class VendorPaymentActivity extends Activity implements GSyncable {
        ...
        dueAMountTextWatcher=new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                try {
                    ...
                    VendorDuePayAmount.setText(String.valueOf(Double.parseDouble(VendorPayGrandtotal.getText().toString()) - Double.parseDouble(UserPayAmount.getText().toString())));
                } catch (Exception ex) {
                        ex .printStackTrace();
                }
    ...
    protected  Bundle getSyncBudle()
    {
       ...
       */
        DBhelper mydb = new DBhelper(VendorPaymentActivity.this);
        ...
        b.putString("d4s", "Vend_Pay");//D4SRS_Po
...
//    });
    ...
    class GSyncStatusHandler extends Handler
    {
        ...
        {
            VendorPaymentActivity.this.updateStatus(msg);
        }
    };
    ...
    class GBrowserNotifyHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            VendorPaymentActivity.this.updateNotify(msg.getData().getString("browsernotifymsg"));
        }
    };
    ...
    class GSyncResultHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            VendorPaymentActivity.this.updateResult(msg.getData().getString("syncstatusmsg"));
        }
    };
    ...
    class GSyncItemStatusHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            VendorPaymentActivity.this.updateItemStatus(msg.getData().getString("itemname"), msg.getData().getString("msg"));
        }
    };
