...
public class UserManagementActivity extends Activity implements GSyncable{
    ...
    protected  Bundle getSyncBudle()
    {
       ...
       */
        DBhelper mydb = new DBhelper(UserManagementActivity.this);
        ...
        b.putString("d4s",                 "Synctype=RS_Store");//D4S
...
//		});
    ...
    class GSyncStatusHandler extends Handler
    {
        ...
        {
            UserManagementActivity.this.updateStatus(msg);
        }
    };
    ...
    class GBrowserNotifyHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            UserManagementActivity.this.updateNotify(msg.getData().getString("browsernotifymsg"));
        }
    };
    ...
    class GSyncResultHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            UserManagementActivity.this.updateResult(msg.getData().getString("syncstatusmsg"));
        }
    };
    ...
    class GSyncItemStatusHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            UserManagementActivity.this.updateItemStatus(msg.getData().getString("itemname"), msg.getData().getString("msg"));
        }
    };
