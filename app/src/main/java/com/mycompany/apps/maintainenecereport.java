...
public class maintainenecereport extends Activity implements GSyncable{
    ...
    protected static Bundle getSyncBudle()
    {
       ...
       */
        ...
        b.putString("syncServerUsername",  "1465630191");//sync user name
...
//    });
    ...
    class GSyncStatusHandler extends Handler
    {
        ...
        {
            maintainenecereport.this.updateStatus(msg);
        }
    };
    ...
    class GBrowserNotifyHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            maintainenecereport.this.updateNotify(msg.getData().getString("browsernotifymsg"));
        }
    };
    ...
    class GSyncResultHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            maintainenecereport.this.updateResult(msg.getData().getString("syncstatusmsg"));
        }
    };
    ...
    class GSyncItemStatusHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
            maintainenecereport.this.updateItemStatus(msg.getData().getString("itemname"), msg.getData().getString("msg"));
        }
    };
